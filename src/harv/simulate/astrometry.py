...
def fake_parallax_factor(
    ...
    ang = Quantity(2 * jnp.pi * ustrip("yr", time), "rad")
...
def simulate_gaia_epoch_astrometry(
    ...
    mu_alpha: Quantity["angular speed"] | None = None,
    mu_delta: Quantity["angular speed"] | None = None,
    parallax: Quantity["angle"] | None = None,
    # Uncertainty
    al_error: Quantity["angle"] | None = None,
    # Reference time
    t_ref: Quantity["time"] | None = None,
) -> tuple[GaiaAstrometryData, dict]:
