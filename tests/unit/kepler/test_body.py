...
class TestEccentricOrbit:
    ...
    def test_velocity_pericenter_gt_apocenter(self) -> None:
        ...
        v_peri = body.get_velocity(Q(0.0, "yr"))
        v_apo = body.get_velocity(Q(0.5, "yr"))
...
class TestJAXCompat:
    def test_pytree_flatten_unflatten(self) -> None:
        ...
        r = body.get_position(Q(0.1, "yr"))
        r2 = body2.get_position(Q(0.1, "yr"))
    ...
    def test_vmap_over_time(self) -> None:
        ...
        body = _make_circular_body()
        times = Q(jnp.array([0.0, 0.25, 0.5, 0.75]), "yr")
